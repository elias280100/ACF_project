module tb_mult_4bit;
    ...
    initial begin
        ...
        $display("\n--- Test 4: All Three Multiplications ---");
        test_mult_add(4'd2, 4'd2, 4'd3, 4'd3, 4'd2, 4'd2, 9'd17);     // 2×2 + 3×3 + 2×2 = 4 + 9 + 4 = 17
        ...
        $display("\n--- Test 5: Larger Numbers ---");
        test_mult_add(4'd5, 4'd4, 4'd3, 4'd6, 4'd2, 4'd7, 9'd52);     // 5×4 + 3×6 + 2×7 = 20 + 18 + 14 = 52
        $display("Products: %d, %d, %d", product, product2, product3);
        test_mult_add(4'd8, 4'd8, 4'd9, 4'd9, 4'd6, 4'd6, 9'd181);    // 8×8 + 9×9 + 6×6 = 64 + 81 + 36 = 181
        $display("Products: %d, %d, %d", product, product2, product3);
        
        // Test 6: Maximum values
        $display("\n--- Test 6: Maximum Values ---");
        test_mult_add(4'd15, 4'd15, 4'd15, 4'd15, 4'd15, 4'd15, 9'd675); // 15×15 + 15×15 + 15×15 = 225 + 225 + 225 = 675 (aber max 9-Bit = 511, overflow!)
